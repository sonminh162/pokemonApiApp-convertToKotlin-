...
class PokemonInformationActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        pokemonViewModel?.getName(this,searchKey)
        pokemonViewModel?.getDescription(this,searchKey)
        pokemonViewModel?.getUrlImage(this,searchKey)
    ...
    private fun setUpUi() {
        ...
        pokemonViewModel?.nameMutableLiveData?.observe(this,
            Observer<String> { t ->
                titlePokemonName.text = CaseFormat.UPPER_UNDERSCORE.to(CaseFormat.UPPER_CAMEL, t)
            })

        pokemonViewModel?.descriptionMutableLiveData?.observe(this,
            Observer<String> { t ->
                descriptionPokemon.text = t
            })
    ...
    private fun turnOnState(currentButton: TextView) {
    ...
    private fun turnOffState(currentButton: TextView) {
